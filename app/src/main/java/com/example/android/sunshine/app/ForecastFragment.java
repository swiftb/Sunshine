...
//            String url = "http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecastAdapter = new ArrayAdapter<String>(
                getActivity(), R.layout.list_item_forecast, R.id.list_item_forecast_textview, forecastList);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                // Inspiration: stackoverflow.com/questions/19167954/use-uri-builder-in-android-or-create-url-with-variables
...
//                Log.v(LOG_TAG, "Weather request URI: " + uri);
...
//                Log.v(LOG_TAG, "Forecast JSON string: " + forecastJsonStr);
            ...
            try {
                weatherArray = getWeatherDataFromJson(forecastJsonStr, days);
